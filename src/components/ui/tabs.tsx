...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-muted data-[state=active]:dark:bg-[#1F2933]",
      "data-[state=active]:text-foreground data-[state=active]:dark:text-white",
